...
#[server(name = "hello-server", version = "1.1.2")]
impl HelloServer {
...
TurboMCP v1.1.2 includes security features:
...
```
TurboMCP Performance Characteristics (v1.1.2)
==================================================
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: server
        image: your-registry/turbomcp-server:v1.1.2
        ports:
        - containerPort: 8080
        env:
        - name: TRANSPORT
