...
```toml
[dependencies]
turbomcp-core = { version = "3.2.0", default-features = false }
```
...
```toml
[dependencies]
turbomcp-wasm = { version = "3.2.0", default-features = false, features = ["wasm-server"] }
worker = "0.8"
...
```toml
[dependencies]
turbomcp-wasm = { version = "3.2.0", default-features = false, features = ["macros"] }
worker = "0.8"
serde = { version = "1.0", features = ["derive"] }
schemars = "1.2"
```
