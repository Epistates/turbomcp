...
```toml
turbomcp = { version = "3.2.1", features = ["full", "auth"] }
```
...
```toml
turbomcp = { version = "3.2.1", features = ["http", "websocket"] }
tokio = { version = "1", features = ["full"] }
```
...
```toml
turbomcp = { version = "3.2.1", features = ["http", "auth"] }
```

**For DPoP token binding:**

```toml
turbomcp = { version = "3.2.1", features = ["http", "auth", "dpop"] }
```

**For performance-critical applications:**

```toml
turbomcp = { version = "3.2.1", features = ["full"] }
```
...
```toml
turbomcp = { version = "3.2.1", features = ["http", "telemetry"] }
```
...
turbomcp = { version = "3.2.1", features = ["experimental-tasks"] }
```
