...
```toml
turbomcp = { version = "3.4.0", features = ["full", "auth"] }
```
...
```toml
turbomcp = { version = "3.4.0", features = ["http", "websocket"] }
tokio = { version = "1", features = ["full"] }
```
...
```toml
turbomcp = { version = "3.4.0", features = ["http", "auth"] }
```

**For DPoP token binding:**

```toml
turbomcp = { version = "3.4.0", features = ["http", "auth", "dpop"] }
```
...
```toml
turbomcp = { version = "3.4.0", features = ["http", "telemetry"] }
```
...
turbomcp = { version = "3.4.0", features = ["experimental-tasks"] }
```
