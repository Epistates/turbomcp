//! Metrics and observability for robust transport operations
//!
...
/// Robust transport metrics collection
...
mod tests {
    ...
    async fn test_metrics_recording() {
        let metrics = RobustTransportMetrics::new();
