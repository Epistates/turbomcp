//! Transport robustness features for fault tolerance and reliability
//!
...
//! ## Architecture
//!
//! The robustness module is organized into focused components:
//!
//! ```text
//! robustness/
...
//! └── transport.rs        # Main RobustTransport wrapper
//! ```
//!
//! ## Quick Start
//!
//! ```rust,no_run
//! use turbomcp_transport::robustness::{RobustTransport, RetryConfig, CircuitBreakerConfig};
//! use turbomcp_transport::stdio::StdioTransport;
//! use turbomcp_transport::Transport;  // Needed for connect() method
//!
//! # async fn example() -> Result<(), Box<dyn std::error::Error>> {
//! // Create a robust transport wrapper
//! let base_transport = StdioTransport::new();
//! let mut robust = RobustTransport::with_defaults(Box::new(base_transport));
//!
//! // Start health monitoring
//! robust.start_health_monitoring().await;
//!
//! // Connect with automatic retry
//! robust.connect().await?;
//!
//! // Get metrics
//! let metrics = robust.get_metrics_snapshot().await;
...
pub use metrics::{LatencyTracker, MetricsSnapshot, RobustTransportMetrics};
pub use retry::{RetryCondition, RetryConfig};
pub use transport::RobustTransport;

/// Presets for common robustness configurations
pub mod presets {
    use super::*;
    use std::time::Duration;
