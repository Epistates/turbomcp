//! Robust transport wrapper with comprehensive resilience features
//!
//! This module provides the main RobustTransport wrapper that combines:
...
use super::metrics::RobustTransportMetrics;
...
impl RobustTransport {
    ...
    /// Create a robust transport with default configurations
    ...
    /// Create a robust transport optimized for network operations
    ...
    /// Get robust transport metrics snapshot
