...
//!
//! OAuth 2.1, API key authentication, and authorization functionality for the
//! TurboMCP protocol with MCP specification compliance.
//!
//! ## Features
//!
...
//! - **DPoP Support** - Optional RFC 9449 proof-of-possession tokens (feature: `dpop`)
//!
//! ## Architecture
//!
//! - `config` - Configuration types for authentication providers
//! - `types` - Core authentication types (AuthContext, UserInfo, TokenInfo)
