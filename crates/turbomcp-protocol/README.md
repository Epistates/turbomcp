...
```toml
[dependencies]
turbomcp-protocol = "3.0.1"
```

Only the experimental Tasks API (SEP-1686) requires a feature flag:
```toml
[dependencies]
turbomcp-protocol = { version = "3.0.1", features = ["experimental-tasks"] }
```
...
```toml
[dependencies]
turbomcp-protocol = "3.0.1"  # All core features included
```
...
**After (v3.0):**
```toml
turbomcp-protocol = "3.0.1"  # All features included by default
```
...
```toml
[dependencies]
turbomcp-protocol = { version = "3.0.1", default-features = false, features = ["std"] }
```

**High-performance build:**
```toml
[dependencies]
turbomcp-protocol = { version = "3.0.1", features = ["simd", "zero-copy", "lock-free"] }
```

**Observable production build:**
```toml
[dependencies]
turbomcp-protocol = { version = "3.0.1", features = ["simd", "tracing", "metrics"] }
```
