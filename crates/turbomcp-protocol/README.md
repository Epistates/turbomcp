...
```toml
[dependencies]
turbomcp-protocol = "3.4.0"
```

Only the experimental Tasks API (SEP-1686) requires a feature flag:
```toml
[dependencies]
turbomcp-protocol = { version = "3.4.0", features = ["experimental-tasks"] }
```
...
```toml
[dependencies]
turbomcp-protocol = "3.4.0"  # All core features included
```
...
**After (v3.0):**
```toml
turbomcp-protocol = "3.4.0"  # All features included by default
```
...
```toml
[dependencies]
turbomcp-protocol = { version = "3.4.0", default-features = false, features = ["std"] }
```

**High-performance build:**
```toml
[dependencies]
turbomcp-protocol = { version = "3.4.0", features = ["simd", "zero-copy", "lock-free"] }
```

**Observable production build:**
```toml
[dependencies]
turbomcp-protocol = { version = "3.4.0", features = ["simd", "tracing", "metrics"] }
```
