...
impl RequestRouter {
    ...
    pub fn new(
        ...
        server_config: crate::config::ServerConfig,
        #[cfg(feature = "experimental-tasks")] task_storage: Option<
            Arc<crate::task_storage::TaskStorage>,
        >,
    ) -> Self {
    ...
    /// # Errors
    ///
    /// Returns an [`crate::McpError`] if a route for the same method already exists.
